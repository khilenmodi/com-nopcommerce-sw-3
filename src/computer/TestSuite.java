...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException{
       ...
       //2.13 Verify the Message "The product has been added to your shopping cart" on Top
        ...
        driver.findElement(By.id("BillingNewAddress_FirstName")).sendKeys("khilen");
        driver.findElement(By.id("BillingNewAddress_LastName")).sendKeys("modi");
        driver.findElement(By.id("BillingNewAddress_Email")).sendKeys("khilenmodi1234@yahoo.com");
        driver.findElement(By.id("BillingNewAddress_Company")).sendKeys("khilenmodi");
       ...
       // select1.selectByVisibleText("Other");
        ...
        driver.findElement(By.id("CardholderName")).sendKeys("khilen modi");
