...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException{
       ...
       //2.11 Then MouseHover on "Shopping cart" and Click on "GO TO CART" button.
        ...
        driver.findElement(By.id("Email")).sendKeys("khilenpatel1@yahoo.com");
        driver.findElement(By.id("Password")).sendKeys("khi1234@");
        driver.findElement(By.id("ConfirmPassword")).sendKeys("khi1234@");
        ...
        driver.findElement(By.xpath("//label[contains(text(),'First name:')]")).sendKeys("khilen");
        driver.findElement(By.id("BillingNewAddress_LastName")).sendKeys("patel");
        driver.findElement(By.id("BillingNewAddress_Email")).sendKeys("khilenpatel12@yahoo.com");
        ...
        driver.findElement(By.id("BillingNewAddress_Address1")).sendKeys("20,vista avenue");
        driver.findElement(By.id("BillingNewAddress_ZipPostalCode")).sendKeys("WD25 2XN");
        driver.findElement(By.id("BillingNewAddress_PhoneNumber")).sendKeys("07903845739");
        ...
        driver.findElement(By.id("CardholderName")).sendKeys("khilen patel");
